package com.odevpedro.yugiohcollections.deck.src.adapter.in.rest;
...
public class DeckController {
    ...
    public ResponseEntity<DeckOutputDTO> create(@RequestBody DeckInputDTO dto) {
        ...
        return ResponseEntity.ok(deckDtoMapper.toOutput(created));
    }
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<?> delete(@PathVariable Long id, @RequestParam String ownerId) {
